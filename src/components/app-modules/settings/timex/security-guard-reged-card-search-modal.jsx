...
const schema = {
  SecurityGuardMemberID: Joi.number(),
...
const SecurityGuardRegedCardSearchModal = ({
  isOpen,
  filter,
  onOk,
  onCancel,
  ...
  const clearRecord = async () => {
    ...
    try {
      ...
      record.SecurityGuardMemberID = 0;
      record.EmployeeID = 0;
  ...
  useMount(async () => {
    ...
    try {
      ...
      const { Employees, SecurityGuards, CurrentDateTime } = data;
    ...
    >
      <Form ref={formRef} name="dataForm">
        <Row gutter={[10, 5]} style={{ marginLeft: 1 }}>
          <Col xs={24}>
            <DropdownItem
              title={Words.security_guard}
              dataSource={securityGuards}
              keyColumn="SecurityGuardMemberID"
...
export default SecurityGuardRegedCardSearchModal;
