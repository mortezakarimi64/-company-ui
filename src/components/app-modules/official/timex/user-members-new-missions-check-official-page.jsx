...
import SearchModal from "./user-members-new-missions-check-official-search-modal";
import DetailsModal from "./user-members-new-missions-check-official-details-modal";
...
const getSheets = (records) => [
  {
    title: "MissionWaitForOfficialCheck",
    data: records,
    columns: [
...
const UserMembersNewMissionsCheckOfficialPage = ({ pageName }) => {
  const {
    progress,
    setProgress,
    searched,
      ...
      <Spin spinning={progress}>
        <Row gutter={[10, 15]}>
          <SimpleDataPageHeader
            title={Words.members_missions_check_official}
            sheets={getSheets(records)}
            fileName="MissionWaitForOfficialCheck"
...
export default UserMembersNewMissionsCheckOfficialPage;
