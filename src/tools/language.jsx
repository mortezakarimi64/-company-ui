export const language = {
  ...
  pagination: {
    ...
    labelRowsSelect: "ردیف ها",
  },
};

export const errorLanguage = {
  root: "value",
  key: "{{!label}} ",
  messages: {
    wrapArrays: true,
  ...
  number: {
    ...
    min: "باید بزرگتر یا برابر  {{limit}} باشد",
    max: "باید کوچکتر یا برابر {{limit}} باشد",
    less: "باید کمتر از {{limit}} باشد",
    greater: "باید بیشتر از {{limit}} باشد",
    integer: "must be an integer",
    negative: "باید عدد منفی باشد",
  ...
  string: {
    base: "باید رشته باشد",
    min: "حداقل تعداد کاراکتر مجاز برای {{!label}} باید بیشتر از {{limit}} باشد",
    max: "حداکثر تعداد کاراکتر مجاز برای {{!label}} باید کمتر از {{limit}} باشد",
    length: "باید {{limit}} کاراکتری باشد",
    alphanum: "باید شامل حروف و اعداد باشد",
    token: "must only contain alpha-numeric and underscore characters",
    regex: {
      base: "دارای مقادیر غیرمجاز است.",
    ...
    trim: "نمی تواند دارای فضای خالی باشد",
